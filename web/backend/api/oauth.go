...
func (h *Handler) registerOAuthRoutes(mux *http.ServeMux) {
	mux.HandleFunc("GET /oopsclaw/oauth/providers", h.handleListOAuthProviders)
	mux.HandleFunc("POST /oopsclaw/oauth/login", h.handleOAuthLogin)
	mux.HandleFunc("GET /oopsclaw/oauth/flows/{id}", h.handleGetOAuthFlow)
	mux.HandleFunc("POST /oopsclaw/oauth/flows/{id}/poll", h.handlePollOAuthFlow)
	mux.HandleFunc("POST /oopsclaw/oauth/logout", h.handleOAuthLogout)
	mux.HandleFunc("GET /oopsclaw/oauth/callback", h.handleOAuthCallback)
}
